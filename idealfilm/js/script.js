...
$document.ready(function () {
  ...
  $(document).ready(function () {
    $('body').find('.rd-audio').addClass('player-hidden');

    $('body').delegate('.rd-audio-close','click', function (e) {
      var $this = $(this);
      e.preventDefault();
      $this.parents('.rd-audio').find('audio')[0].pause();
      $this.parents('.rd-audio').addClass('player-hidden');
      $('.rd-audio-playlist').find('.playing').removeClass('playing')
    });

    $('.rd-audio-playlist').delegate('.audio-track','click', function (e) {
      var $this = $(this);
      e.preventDefault();
      $('.rd-audio').removeClass('player-hidden');
    });
